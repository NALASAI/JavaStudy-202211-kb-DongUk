...
-- 테이블 데이터 db_study.product_mst:~12 rows (대략적) 내보내기
...
INSERT INTO `product_mst` (`id`, `product_name`, `product_price`) VALUES
	...
	(6, '스타벅스 블루 머그컵', 15000),
	(7, '스타벅스 블랙  머그컵2', 15000),
	(8, '스타벅스 화이트 머그컵2', 20000),
	(9, '스타벅스 블루 머그컵2', 15000),
	(19, '스타벅스 블랙  머그컵3', 15000),
	(20, '스타벅스 화이트 머그컵3', 20000),
	(21, '스타벅스 블루 머그컵3', 15000);
...
INSERT INTO `user_dtl` (`id`, `phone`, `address`, `create_date`, `update_date`) VALUES
	(1, NULL, NULL, '2022-12-09 11:21:52', '2022-12-09 11:21:52'),
	(3, NULL, NULL, '2022-12-09 11:21:52', '2022-12-09 11:21:52'),
	(4, NULL, NULL, '2022-12-09 11:21:52', '2022-12-09 11:21:52');
...
INSERT INTO `user_mst` (`id`, `username`, `password`, `name`, `email`, `create_date`, `update_date`) VALUES
	...
	(2, 'bbb', '1234', '강동욱', 'ebyul96428@naver.com', '2022-12-09 11:21:52', '2022-12-09 11:21:52'),
	(3, 'ccc', '1234', '강동욱', 'ebyul96428@naver.com', '2022-12-09 11:21:52', '2022-12-09 11:21:52'),
	(4, 'ddd', '1234', '강동욱', 'ebyul96428@naver.com', '2022-12-09 11:21:52', '2022-12-09 11:21:52');

-- 트리거 db_study.user_mst_after_delete 구조 내보내기
DROP TRIGGER IF EXISTS `user_mst_after_delete`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `user_mst_after_delete` AFTER DELETE ON `user_mst` FOR EACH ROW BEGIN
	DELETE
	FROM
		user_dtl
	WHERE
...
-- 트리거 db_study2.status_mst_after_insert 구조 내보내기
DROP TRIGGER IF EXISTS `status_mst_after_insert`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `status_mst_after_insert` AFTER INSERT ON `status_mst` FOR EACH ROW BEGIN
