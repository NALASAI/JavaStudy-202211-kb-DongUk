...
INSERT INTO `emp_mst` VALUES (1,'문성현'),(3,'문자영'),(2,'윤대휘'),(4,'정규민');
...
INSERT INTO `student_mst` VALUES (1,'신경수',1),(2,'고희주',2),(3,'장건녕',3),(4,'문승주',4),(5,'이승아',3);
...
INSERT INTO `order_mst` VALUES (1,'앗 뜨거워! 핫해! 겨울 신발 특가 LIVE',39000,99),(2,'네퓨어 마스크의 특집 영물 라이브',41900,500),(3,'겨울엔 기린호빵',9900,100),(4,'셀렉스 하반기 결산 어워즈 셀렉스 코어 프로팅 프로 스틱',11650,50),(5,'앗 뜨거워! 핫해! 겨울 신발 특가 LIVE',39000,10),(6,'앗 뜨거워! 핫해! 겨울 신발 특가 LIVE',39000,5),(7,'앗 뜨거워! 핫해! 겨울 신발 특가 LIVE',39000,50),(8,'네퓨어 마스크의 특집 영물 라이브',41900,100),(9,'네퓨어 마스크의 특집 영물 라이브',41900,50),(10,'겨울엔 기린호빵',9900,50),(11,'셀렉스 하반기 결산 어워즈 셀렉스 코어 프로팅 프로 스틱',11650,30),(12,'셀렉스 하반기 결산 어워즈 셀렉스 코어 프로팅 프로 스틱',11650,10);
...
INSERT INTO `user_dtl` VALUES (1,'강동욱','ebyul96428@naver.com','01052204331'),(2,'강동이','ebyul96428@naver.com','01052204331'),(3,NULL,NULL,NULL),(4,NULL,NULL,NULL),(5,NULL,NULL,NULL),(6,NULL,NULL,NULL),(7,NULL,NULL,NULL);
...
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `user_mst_after_insert` BEFORE INSERT ON `user_mst` FOR EACH ROW BEGIN
	INSERT INTO
        ...
        (id)
	values
		(NEW.id); /*NULL 허용으로 되어있는 경우, id만 입력하면 나머지 컬럼엔 null이 들어간다*/
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
INSERT INTO `product_mst` VALUES (1,'스타벅스 블랙 텀블러',25000),(2,'스타벅스 화이트 텀블러',30000),(3,'스타벅스 블루 텀블러',20000),(4,'스타벅스 블랙  머그컵',15000),(5,'스타벅스 화이트 머그컵',20000),(6,'스타벅스 블루 머그컵',15000),(7,'스타벅스 블랙  머그컵2',15000),(8,'스타벅스 화이트 머그컵2',20000),(9,'스타벅스 블루 머그컵2',15000),(19,'스타벅스 블랙  머그컵3',15000),(20,'스타벅스 화이트 머그컵3',20000),(21,'스타벅스 블루 머그컵3',15000);
...
LOCK TABLES `student_mst` WRITE;
/*!40000 ALTER TABLE `student_mst` DISABLE KEYS */;
INSERT INTO `student_mst` VALUES (1,'임지현',1,80),(2,'신경수',2,100),(4,'문승주',1,85),(5,'장건녕',2,95),(6,'박수현',3,90),(7,'황성민',1,80),(8,'박준현',2,100),(9,'이승아',3,90),(12,NULL,1,100);
/*!40000 ALTER TABLE `student_mst` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `user_mst` WRITE;
/*!40000 ALTER TABLE `user_mst` DISABLE KEYS */;
INSERT INTO `user_mst` VALUES (1,'aaa','1234','강동욱','ebyul96428@naver.com','2022-12-09 11:21:52','2022-12-09 11:21:52'),(2,'bbb','1234','강동욱','ebyul96428@naver.com','2022-12-09 11:21:52','2022-12-09 11:21:52'),(3,'ccc','1234','강동욱','ebyul96428@naver.com','2022-12-09 11:21:52','2022-12-09 11:21:52'),(4,'ddd','1234','강동욱','ebyul96428@naver.com','2022-12-09 11:21:52','2022-12-09 11:21:52');
/*!40000 ALTER TABLE `user_mst` ENABLE KEYS */;
UNLOCK TABLES;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
